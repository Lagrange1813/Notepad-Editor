...
import {disableBarButtons, enableBarButtons, removeCurrentButtons, setCurrentButtons,} from "../hook/setButtons";
...
export const highlightToolbarWYSIWYG = (vditor: LGEditor) => {
  ...
  vditor.wysiwyg.hlToolbarTimeoutId = window.setTimeout(() => {
    ...
    removeCurrentButtons(Constants.EDIT_TOOLBARS);
    enableToolbar(vditor.toolbar.elements, Constants.EDIT_TOOLBARS);
    enableBarButtons(Constants.EDIT_TOOLBARS);
