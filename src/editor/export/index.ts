...
<script src="${vditor.options.cdn}/dist/lib/i18n/${vditor.options.lang}.js"></script>
...
<script src="${vditor.options.cdn}/dist/lib/icons/${vditor.options.icon}.js"></script></body></html>`;
